...
void loadList(listElement *start){
	...
	system("dir /b *.txt"); // dir /b *.txt for windowsgnuplot
        ...
        do{
            ...
            for (i = 0; i < lenOfList - 1; i++){
                    ...
                    case 1: // last name 
                        ...
                        strcpy(temp2, (currElem->nextElem)->lastName);           //last name of element after current element
                        strcpy(temp1, currElem->lastName);                       //last name of current element
                    ...
                    case 2: // first name   
                        ...
                        strcpy(temp2,(currElem->nextElem)->firstName);           //last name of element after current element
                        strcpy(temp1,currElem->firstName);                       //last name of current element
                    ...
                    case 3: // age  
                        ...
                        //Check swapFlagg
                        if ((currElem->nextElem)->age < currElem->age) swapFLAGG = 1;
